...
class Eliza(MycroftSkill):
    ...
    def initialize(self):
        self.therapist = ElizaBot()
        self.therapist.load('doctor.txt')

    @intent_file_handler('eliza.intent')
    def handle_eliza(self, message):
        self.conversing = True
        request = self.get_response('eliza')
        while self.conversing:
            reply = self.therapist.respond(request)
            request = self.get_response(reply)
...
# via https://github.com/wadetb/eliza
class ElizaBot:
    def __init__(self):
        self.initials = []
        self.finals = []
